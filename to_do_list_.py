...
gui.geometry("500x500") # dimensions of the GUI application
...
my_list=Listbox(my_frame,font=font_used,width=25,height=5,bg="SystemButtonFace",bd=0,fg='#464646',
                ...
                selectbackground="#828282",
                activestyle="none")

my_list.pack(side=LEFT,fill=BOTH)

# items contains the list of to-do things
items=["do gym and yoga","have breakfast","take a bath","go to office"]
...
def delete_crossed():
    ...
    while count<my_list.size():
        if my_list.itemcget(count,"fg")=="#d9d9d9":
